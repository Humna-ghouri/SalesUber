...
const Header = () => {
  return (
    ...
    const AboutUs = () => {
        return (
          <div className="flex justify-center px-2 sm:px-10"> {/* Adjusted padding for small screens */}
            <div className="w-full max-w-[90%] p-2 sm:p-6"> {/* Adjusted width and padding */}
              {/* About Us Section */}
              <section className="mb-8 sm:mb-12 ml-1 sm:ml-6 md:ml-8"> {/* Adjusted margins */}
                <h1 className="text-3xl sm:text-4xl font-black mb-4 sm:mb-6 text-black">About Us</h1>
                <h2 className="text-2xl sm:text-4xl font-extrabold mb-4 sm:mb-6 text-gray-800">
              ...
              {/* Our Mission Section */}
              <section className="mb-8 sm:mb-12 ml-1 sm:ml-6 md:ml-8">
                <h1 className="text-3xl sm:text-4xl font-black mb-4 sm:mb-6 text-black">Our Mission</h1>
                <p className="mb-4 sm:mb-6 text-base sm:text-lg text-gray-700">
              ...
              {/* What We Do Section */}
              <section className="mb-8 sm:mb-12 ml-1 sm:ml-6 md:ml-8">
                <h1 className="text-3xl sm:text-4xl font-black mb-4 sm:mb-6 text-black">What We Do</h1>
                <p className="mb-4 sm:mb-6 text-base sm:text-lg text-gray-700">
              ...
              {/* Our Values Section */}
              <section className="mb-8 sm:mb-12 ml-1 sm:ml-6 md:ml-8">
                <h1 className="text-3xl sm:text-4xl font-black text-center mb-4 sm:mb-8 text-black">Our Values</h1>
                <h2 className="text-2xl sm:text-4xl font-extrabold text-center mb-4 sm:mb-6 text-gray-800">
              ...
              <section className="mb-8 sm:mb-12 ml-1 sm:ml-6 md:ml-8">
                <h2 className="text-2xl sm:text-4xl font-extrabold mb-4 sm:mb-6 text-black">Our Approach Includes:</h2>
                <div className="space-y-4 sm:space-y-6">
                  <p className="text-base sm:text-lg text-gray-700">
              ...
              <section className="mb-8 sm:mb-12 ml-1 sm:ml-6 md:ml-8">
                <h2 className="text-2xl sm:text-4xl font-extrabold mb-4 sm:mb-6 text-black">Serving Our Communities</h2>
                <p className="text-base sm:text-lg text-gray-700">
              ...
              <section className="mb-8 sm:mb-12 ml-1 sm:ml-6 md:ml-8">
                <h2 className="text-2xl sm:text-4xl font-extrabold mb-4 sm:mb-6 text-black">Partner with Us</h2>
                <p className="text-base sm:text-lg text-gray-700">
      ...
      const Footer = () => {
  return (
    <footer className="text-center py-10 bg-blue-950 text-white h-[90%]">
